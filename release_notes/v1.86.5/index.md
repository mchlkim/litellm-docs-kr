...
`v1.86.5` 는 다음 버전을 기반으로 한 패치 릴리스입니다: [`v1.86.4`](/release_notes/v1.86.4/v1-86-4). 이 릴리스는 다음 항목을 추가합니다: Claude Fable 5, backports the CrowdStrike AIDR identity capture 및 follow-up fix (an upgrade-monotonicity backport 따라서 the 1.86 line keeps AIDR identity attribution), 및 authorizes batch files 사용해 the upload `target_model_names`.

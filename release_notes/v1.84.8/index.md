...
`v1.84.8` 는 다음 버전을 기반으로 한 패치 릴리스입니다: [`v1.84.7`](/release_notes/v1.84.7/v1-84-7). 이 릴리스는 다음 수정 사항을 백포트합니다: a database-resilience set (Prisma reconnection, prepared-statement 및 timeout controls, 5xx on DB infra errors during auth) 및 the complete grace-period key rotation fix, 추가로 routing 및 streaming corrections.

### 변경 사항

- fix(anthropic): streaming reasoning token 사용량 계산 수정 - [PR #27319](https://github.com/BerriAI/litellm/pull/27319)
- fix(proxy): grace-period key rotation의 deprecated-key 조회 수정 - [PR #27756](https://github.com/BerriAI/litellm/pull/27756)

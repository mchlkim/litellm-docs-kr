...
`v1.87.3` 는 다음 버전을 기반으로 한 패치 릴리스입니다: [`v1.87.2`](/release_notes/v1.87.2/v1-87-2). 이 릴리스는 다음 항목을 반영합니다: the 1.84.8 database-resilience set onto the 1.87 line, adds the budget-reservation toggle, hardens Anthropic streaming logging, 및 refreshes dependencies.

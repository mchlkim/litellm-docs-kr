...
| [v1.82.0](/release_notes/v1.82.0/v1-82-0)   | Feb 28, 2026 | Realtime 가드레일, Projects Management, and 10+ Performance Optimizations |
| [v1.81.14](/release_notes/v1.81.14/v1-81-14) | Feb 21, 2026 | New Gateway Level 가드레일 & Compliance Playground       |
...
| [v1.81.6](/release_notes/v1.81.6/v1-81-6)   | Jan 31, 2026 | 로그 v2 with Tool Call Tracing                             |
| [v1.81.3](/release_notes/v1.81.3/v1-81-3)   | Jan 26, 2026 | Performance — 25% CPU 사용법 Reduction                      |
...
| [v1.80.0](/release_notes/v1.80.0-stable/v1-80-0)   | Nov 15, 2025 | Introducing Agent Hub: 등록, Publish, and Share Agents |
| [v1.79.3](/release_notes/v1.79.3-stable/v1-79-3)   | Nov 8, 2025  | Built-in 가드레일 on AI Gateway                          |

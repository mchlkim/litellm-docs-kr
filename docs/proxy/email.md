...
On the LiteLLM Proxy UI, go to 가상 키 > Create API Key > Select User ID
...
On the LiteLLM Proxy UI, go to 가상 키 > Click on a key > Click "Regenerate Key"
...
Customizing Email Branding is an 엔터프라이즈 Feature [Get in touch with us for a Free Trial](https://enterprise.litellm.ai/demo)
...
| Field | Environment Variable | Type | Default Value | 예제 | Description |
|-------|-------------------|------|---------------|---------|-------------|

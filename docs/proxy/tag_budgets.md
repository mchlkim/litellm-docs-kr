...
**예제:** Create a tag for your Engineering department with a monthly $500 budget
...
Navigate to **가상 키** → **Create Key** (or edit an existing key) and select the tag(s) in the **Tags** field.

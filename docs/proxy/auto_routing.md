...
- **routes**: Array of routing rules with:
  ...
  - **utterances**: 예제 phrases/patterns to match against
...
Navigate to the LiteLLM UI and go to **모델+Endpoints** > **Add Model** > **Auto Router Tab**.
...
- **Utterances** - 예제 phrases that will trigger this route. Use placeholders in brackets for variables:

...
> New to LiteLLM or not sure whether you need the SDK or Gateway path first? Start at [학습 →](/litellm-docs-kr/docs/learn)
...
items={[
  {
    ...
    to: "/litellm-docs-kr/docs/guides/compatibility_extensibility",
  },
  {
    icon: "🧪",
    title: "신뢰성, 테스트 및 비용",
    description: "Retries, fallbacks, mock responses, and budget controls.",
    to: "/litellm-docs-kr/docs/guides/reliability_testing_spend",
  },
  {
    icon: "🔒",
    title: "보안 및 네트워크",
    description: "SSL, custom CA bundles, HTTP proxy settings, and per-service verification.",
    to: "/litellm-docs-kr/docs/guides/security_network",
  },
]}
/>

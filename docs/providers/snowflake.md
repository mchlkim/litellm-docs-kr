...
| Provider 문서 | [Cortex REST API ↗](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-rest-api) |
...
| Model | `litellm` model name | Function Calling | Vision | Prompt 캐싱 |
|---|---|---|---|---|

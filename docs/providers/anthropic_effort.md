...
- [Anthropic provider 가이드](/litellm-docs-kr/docs/providers/anthropic) - thinking, 도구 호출, provider 설정 확인
- [도구 입력 예제](/litellm-docs-kr/docs/providers/anthropic_tool_input_examples) - Claude가 더 정확한 tool input을 생성하도록 예제 제공
- [Programmatic 도구 호출](/litellm-docs-kr/docs/providers/anthropic_programmatic_tool_calling) - Claude가 도구를 호출하는 코드를 작성하도록 설정
- [Prompt 캐싱](/litellm-docs-kr/docs/completion/prompt_caching) - 비용 절감을 위한 프롬프트 캐싱

## 추가 자료

- [Anthropic Effort 문서](https://docs.anthropic.com/en/docs/build-with-claude/effort)
- [LiteLLM Anthropic Provider 가이드](/litellm-docs-kr/docs/providers/anthropic)
- [비용 추적 가이드](/litellm-docs-kr/docs/proxy/cost_tracking)

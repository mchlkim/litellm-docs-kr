...
|-------------------|-------------------------------------------------------------------------------------------------|
| SOC 2 Type I      | Certified. Report available upon request on 엔터프라이즈 plan.                                                           |
| SOC 2 Type II     | Certified. Report available upon request on 엔터프라이즈 plan.                   |
| ISO 27001          | Certified. Report available upon request on 엔터프라이즈                              |
...
- LiteLLM uses minimal cookies, solely for the purpose of allowing Proxy users to access the LiteLLM 관리자 UI.
...
- The 관리자 UI accesses the cookie to authenticate your login session.
...
- ISO 27001. Certified. Report available upon request on 엔터프라이즈 plan.
